...
(function() {
  ...
  intersectSentences = function(s1, s2) {
    ...
    // console.log("==================");
    // console.log("intersectSentences result: ");
      ...
      for (_j = 0, _len1 = sentences.length; _j < _len1; _j++) {
        ...
        if (a !== b) {
          score += intersectSentences(a, b);
            ...
            // console.log(b);
            // console.log("intersectSentences: ");
            // console.log(intersectSentences(a, b));
            // console.log("==================");
        }
      }
